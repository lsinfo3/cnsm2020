...
# TopologyZoo
metrics <- loadRData("../../data/r-files/hyperflow/metrics_HF_2C.Rda")

# LinkRemover
metrics_LR <- loadRData("../../data/r-files/hyperflow/metrics_HF_2C_LR.Rda") 
...
lm <- lm(Hitratio ~ Betweenness, data = train)
